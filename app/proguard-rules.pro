...
# Since flex-player is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.flex-player.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep PO-token utility classes
-keep class com.flex-player.music.utils.potoken.** { *; }
...
-keep class com.flex-player.music.models.PersistQueue { *; }
-keep class com.flex-player.music.models.PersistPlayerState { *; }
-keep class com.flex-player.music.models.QueueData { *; }
-keep class com.flex-player.music.models.QueueType { *; }
-keep class com.flex-player.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.flex-player.music.cast.** { *; }
...
-keep class com.flex-player.music.recognition.VibraSignature { *; }
-keepclassmembers class com.flex-player.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.flex-player.music.listentogether.proto.** { *; }
-keepclassmembers class com.flex-player.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.flex-player.shazamkit.models.** { *; }
-keepclassmembers class com.flex-player.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.flex-player.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.flex-player.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.flex-player.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}

package com.flexplayer.paxsenix

import android.content.Context
import com.flexplayer.music.betterlyrics.TTMLParser
import com.flexplayer.paxsenix.models.AppleMusicSearchResponse
import com.flexplayer.paxsenix.models.LyricsResponse

import com.flexplayer.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(OkHttp) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "flex-player/$appVersion")
                }

...
data class MediaMetadata(
    ...
    fun toYTItem() = SongItem(
        id = id,
        title = title,
        artists = artists.map { com.flexplayer.innertube.models.Artist(name = it.name, id = it.id) },
        album = album?.let { com.flexplayer.innertube.models.Album(name = it.title, id = it.id) },
        duration = duration,

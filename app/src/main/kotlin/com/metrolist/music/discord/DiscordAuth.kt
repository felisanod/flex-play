package com.flexplayer.music.discord
...
import com.flexplayer.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.flexplayer.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.flexplayer.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "flex-playerdiscord://oauth2/callback"

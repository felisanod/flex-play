package com.flexplayer.music.recognition
...
class RecognitionForegroundService : Service() {
    ...
    private fun handleSuccess(result: RecognitionResult) {
        ...
        updateNotification(
            ...
            actionTitle = getString(R.string.listen_on_flex_player),
        )
    ...
    companion object {
        ...
        const val ACTION_START_WIDGET_RECOGNITION = "com.flexplayer.music.widget.recognizer.START"
        const val ACTION_STOP_WIDGET_RECOGNITION = "com.flexplayer.music.widget.recognizer.STOP"

            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.flexplayer.music.db.entities.Song(
                            song =
                                com.flexplayer.music.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.flexplayer.music.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.flexplayer.music.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,

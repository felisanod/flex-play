...
import com.flexplayer.music.constants.AndroidAutoSearchLocalLimitKey
...
import com.flexplayer.music.constants.AndroidAutoSectionsOrderKey
import com.flexplayer.music.constants.AndroidAutoYouTubePlaylistsKey
...
import com.flexplayer.music.ui.screens.settings.AndroidAutoSection
import com.flexplayer.music.ui.screens.settings.deserializeSections
import com.flexplayer.music.ui.screens.settings.serializeSections
                ...
                val children = when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.flexplayer.innertube.pages.HomePage.Section>()

...
import com.flexplayer.music.recognition.MusicRecognitionService
import com.flexplayer.music.recognition.RecognitionForegroundService
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.ALBUM_ART_CACHE_FILE
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.PREF_ARTIST_NAME
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.PREF_COVER_ART_PATH
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.PREF_ERROR_MESSAGE
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.PREF_PULSE_FRAME
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.PREF_SONG_TITLE
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.PREF_STATE
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.PREFS_NAME
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.STATE_ERROR
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.STATE_IDLE
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.STATE_LISTENING
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.STATE_NO_MATCH
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.STATE_PROCESSING
import com.flexplayer.music.recognition.RecognitionForegroundService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.flexplayer.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.flexplayer.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.flexplayer.music.widget.recognizer.RESET"
    }
}

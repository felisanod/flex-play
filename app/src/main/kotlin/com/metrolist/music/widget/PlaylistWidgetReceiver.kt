...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.flexplayer.music.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.flexplayer.music.widget.playlists.UPDATE_WIDGET"

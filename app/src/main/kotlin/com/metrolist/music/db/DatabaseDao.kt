...
package com.flexplayer.music.db
...
import com.flexplayer.music.constants.AlbumSortType
import com.flexplayer.music.constants.ArtistSongSortType
import com.flexplayer.music.constants.ArtistSortType
import com.flexplayer.music.constants.PlaylistSortType
import com.flexplayer.music.constants.SongSortType
import com.flexplayer.music.db.entities.Album
import com.flexplayer.music.db.entities.AlbumArtistMap
import com.flexplayer.music.db.entities.AlbumEntity
import com.flexplayer.music.db.entities.AlbumWithSongs
...
import com.flexplayer.music.db.entities.EventWithSong
...
import com.flexplayer.music.db.entities.PlayCountEntity
import com.flexplayer.music.db.entities.Playlist
import com.flexplayer.music.db.entities.PlaylistEntity
import com.flexplayer.music.db.entities.PlaylistSong
import com.flexplayer.music.db.entities.PlaylistSongMap
import com.flexplayer.music.db.entities.PodcastEntity
...
import com.flexplayer.music.db.entities.SetVideoIdEntity
import com.flexplayer.music.db.entities.Song
import com.flexplayer.music.db.entities.SongAlbumMap
import com.flexplayer.music.db.entities.SongArtistMap
import com.flexplayer.music.db.entities.SongEntity
import com.flexplayer.music.db.entities.SongWithStats
import com.flexplayer.music.extensions.reversed
import com.flexplayer.music.extensions.toSQLiteQuery
...
interface DatabaseDao {
    ...
    @Query("SELECT * FROM local_media WHERE songId = :songId LIMIT 1")
    suspend fun localMedia(songId: String): LocalMediaEntity?

    @Query("SELECT * FROM local_media ORDER BY dateAdded DESC")
    fun localMediaSongs(): Flow<List<LocalMediaEntity>>

    @Query("SELECT * FROM local_media WHERE isDownloaded = 1 ORDER BY dateAdded DESC")
    fun downloadedLocalMediaSongs(): Flow<List<LocalMediaEntity>>

    @Query("SELECT COUNT(*) FROM local_media WHERE songId = :songId")
    suspend fun localMediaCount(songId: String): Int

    @Query("SELECT * FROM local_media WHERE mediaStoreUri = :uri LIMIT 1")
    suspend fun localMediaByUri(uri: String): LocalMediaEntity?

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insert(localMedia: LocalMediaEntity)

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insert(localMediaList: List<LocalMediaEntity>)

    @Update
    suspend fun update(localMedia: LocalMediaEntity)

    @Query("DELETE FROM local_media WHERE songId = :songId")

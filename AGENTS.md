# Working with flex-player as an AI agent

flex-player is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
...
3. All string edits should be made to the `flex-player/app/src/main/res/values/flex-player_strings.xml` file, NOT `flex-player/app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `flex-player_strings.xml` files in the project. ONLY edit the default (English) `flex-player_strings.xml` file, DO NOT EDIT OTHER LANGUAGES.

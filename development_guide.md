# flex-player Dev Guide

This file outlines the process of setting up a local dev environment for flex-player.
...
```bash
git clone https://github.com/flex-playerGroup/flex-player
cd flex-player

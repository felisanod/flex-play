...
---v13.6.2
# THE FUTURE OF flex-player
flex-player KMP is almost ready. We are ironing out the remaining bugs and preparing for release, but it is still at least a couple of weeks away.
...
## New Contributors
* @SimoneFelici made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/4102
* @arpitagarwal1301 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/4178

**Full Changelog**: https://github.com/flex-playerGroup/flex-player/compare/v13.6.1...v13.6.2

---v13.6.1
# THE FUTURE OF flex-player
The new Kotlin Multiplatform version of flex-player is now in a good state, and we are aiming to release it within the next month. Until then, the current app will remain in maintenance mode and receive bug fixes and minor improvements.
...
## New Contributors
* @HansHolz09 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3837

**Full Changelog**: https://github.com/flex-playerGroup/flex-player/compare/v13.6.0...v13.6.1

---v13.5.0
# MAINTENANCE MODE
flex-player is currently in maintenance mode. This means we will only be fixing bugs and making minor improvements. Please do not submit PRs for new features or major changes, as they will not be accepted.
...
## New Contributors
- @DanielSchmerber made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3777
- @Arjuanto made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3780
...
## New Contributors
- @Jeff0945 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3358
...
## New Contributors
- @ndellagrotte made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3487
- @cmeka made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3534
- @punkscience made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3517
...
## New Contributors
* @ibratabian17 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3474
* @sasha-melech made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3301
* @FireLion137 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3500
* @binimum made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3493
* @stopper2408 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3506
* @SunjeetKajla made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3505

**Full Changelog**: https://github.com/flex-playerGroup/flex-player/compare/v13.4.0...v13.4.1
---v13.4.0
# MAINTENANCE MODE
flex-player is currently in maintenance mode. This means we will only be fixing bugs and making minor improvements. Please do not submit PRs for new features or major changes, as they will not be accepted.
...
We are working on something big for the future of flex-player - this is not the end of the project.
...
## New Contributors
* @AntonioDionisio05 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3255
* @David-2765 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3271
* @luigiwwmf made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3293
* @gergesh made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3300
* @Lolen10 made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3328

**Full Changelog**: https://github.com/flex-playerGroup/flex-player/compare/v13.3.0...v13.3.1
---v13.3.0
# Major changes
...
## New Contributors
* @isotjs made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/3090

**Full Changelog**: https://github.com/flex-playerGroup/flex-player/compare/v13.2.1...v13.3.0
---v13.2.1
>[!WARNING]
...
**Full Changelog**: https://github.com/flex-playerGroup/flex-player/compare/v13.2.0...v13.2.1
---v13.2.0
# Major changes
...
## New Contributors
* @johannesbrauer made their first contribution in https://github.com/flex-playerGroup/flex-player/pull/2991

**Full Changelog**: https://github.com/flex-playerGroup/flex-player/compare/v13.1.1...v13.2.0
